...
#ifndef __TdxProxy_i_h__
#define __TdxProxy_i_h__
...
#ifndef __ITdxClient_FWD_DEFINED__
#define __ITdxClient_FWD_DEFINED__
typedef interface ITdxClient ITdxClient;

#endif 	/* __ITdxClient_FWD_DEFINED__ */
...
#ifndef __TdxClient_FWD_DEFINED__
#define __TdxClient_FWD_DEFINED__

#ifdef __cplusplus
typedef class TdxClient TdxClient;
#else
typedef struct TdxClient TdxClient;
#endif /* __cplusplus */

#endif 	/* __TdxClient_FWD_DEFINED__ */
...
#ifndef __ITdxClient_INTERFACE_DEFINED__
#define __ITdxClient_INTERFACE_DEFINED__

/* interface ITdxClient */
/* [unique][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_ITdxClient;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("7ADC239B-6BAB-4FC0-9D17-65E20455B555")
    ITdxClient : public IDispatch
    {
    public:
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE Tdx_Login( 
            BSTR IP,
            SHORT Port,
            BSTR version,
            BSTR AccountNo,
            ...
            BSTR TxPassword,
            BSTR *ErrInfo,
            /* [retval][out] */ LONG *ClientID) = 0;
        
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE Tdx_Init( void) = 0;
        
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE Tdx_Exit( void) = 0;
    ...
    typedef struct ITdxClientVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *Tdx_Login )( 
            ITdxClient * This,
            BSTR IP,
            SHORT Port,
            BSTR version,
            ...
            BSTR TxPassword,
            BSTR *ErrInfo,
            /* [retval][out] */ LONG *ClientID);
        
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *Tdx_Init )( 
            ITdxClient * This);
        
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *Tdx_Exit )( 
            ITdxClient * This);
    ...
    interface ITdxClient
    {
        CONST_VTBL struct ITdxClientVtbl *lpVtbl;
    };
...
#define ITdxClient_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define ITdxClient_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define ITdxClient_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define ITdxClient_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define ITdxClient_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define ITdxClient_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define ITdxClient_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 


#define ITdxClient_Tdx_Login(This,IP,Port,version,AccountNo,JyPassword,TxPassword,ErrInfo,ClientID)	\
    ( (This)->lpVtbl -> Tdx_Login(This,IP,Port,version,AccountNo,JyPassword,TxPassword,ErrInfo,ClientID) ) 

#define ITdxClient_Tdx_Init(This)	\
    ( (This)->lpVtbl -> Tdx_Init(This) ) 

#define ITdxClient_Tdx_Exit(This)	\
    ( (This)->lpVtbl -> Tdx_Exit(This) ) 
...
#endif 	/* __ITdxClient_INTERFACE_DEFINED__ */



#ifndef __TdxProxyLib_LIBRARY_DEFINED__
#define __TdxProxyLib_LIBRARY_DEFINED__

/* library TdxProxyLib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_TdxProxyLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("F33259B0-55E2-43F3-8632-440E98A35020")
CompReg;
#endif

EXTERN_C const CLSID CLSID_TdxClient;

#ifdef __cplusplus

class DECLSPEC_UUID("5281C9E8-EA61-4EAB-ABF2-9BB25C9B6998")
TdxClient;
#endif
#endif /* __TdxProxyLib_LIBRARY_DEFINED__ */
